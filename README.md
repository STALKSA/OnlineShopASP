...
- [ ] Сделайте класс и интерфейс SmtpEmailSender, IEmailSender полностью асинхронными.
- [ ] Реализуйте асинхронное высвобождение ресурсов.
- [ ] Сделайте SmtpEmailSender корректным Scoped сервисом.
